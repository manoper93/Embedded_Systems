...
uint8_t set_display = 1, sw = 0, swpress = 0, actflag500ms = 0, sentido = 0, st = 0, comando = 0, stmotor = 1, swdisplay = 1, i = 0;
int16_t numd0 = 0, numd1 = 0, percentagem = 0, bkp = 0, media_analogica = 0, leituraL = 0, leituraH = 0;
float valor = 0;
			...
			*buffer = rxusart.rx_buffer;
			...
			switch(*buffer){
				...
				case 'b':
					swdisplay = 1;
					if(stmotor > 1){
						sprintf(instrucao, "Velocidade: %i  Porcento | Sentido: Invertido\r\n", percentagem);
						} else if(stmotor == 1){
						sprintf(instrucao, "Velocidade: %i  Porcento | Sentido: Normal\r\n", percentagem);
					}
